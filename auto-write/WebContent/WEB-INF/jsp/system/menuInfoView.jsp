...
<%
	...
	MenuDto menuEntity = (MenuDto) request.getAttribute("MenuEntity");
...
<script>
	function init(){
		...
		frm.menuId.value = "<%=menuEntity.getMenuid()%>";
		frm.menuName.value = "<%=menuEntity.getMenunm()%>";
		frm.menuLevel.value = "<%=menuEntity.getMenulvl()%>";
		frm.menuPageUrl.value = "<%=menuEntity.getMenupageurl()%>";
		frm.menuType.value = "<%=menuEntity.getMenutype()%>";
		frm.menuParentId.value = "<%=menuEntity.getParmenuid()%>";
		frm.menuImagePath.value = "<%=menuEntity.getFstimgpath()%>";
		frm.menuUseYn.value = "<%=menuEntity.getUseyn()%>";
		frm.menuDisplaySeq.value = "";
		frm.menuAllowedUserType.value = "";
	}
...
<form name="menuForm" method="post" action="menuModify.do">
			...
			<td valign="top">
				<div class="admin_center">
					...
					<div class="paging3">
						...
						<a href="javascript:menuModify()"><img class='write' src="./images/board/bt_mod.gif"></a>
					</div>
