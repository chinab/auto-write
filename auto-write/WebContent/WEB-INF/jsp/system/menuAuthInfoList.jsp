				...
				<div class="admin_con">
					...
					<fieldset class="search clfix">
						...
						<select name="searchKey">
							...
							<option value="user_nic" >닉네임</option>
						</select>
						
						<input type="text" class="s_id" name="searchValue" title="검색어를입력하세요" style="width:200;" value="" onkeydown="javascript:if(event.keyCode==13)listBoard('<%= category %>');"/>
						<input type="image" src="./images/board/btn_search2.gif" alt="SEARCH"  onclick="javascript:listBoard('<%= category %>');"/>
					</fieldset>
