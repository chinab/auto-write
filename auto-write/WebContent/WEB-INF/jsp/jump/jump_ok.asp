...
<div style="width:100%; margin-top:30px;"><img src="/new/images/title_dot.gif"><span style="font-weight:bold; padding-left:3px; font-size:17px; color:#219075; font-family:Malgun Gothic;">JUMP</span></div>
...
<td>13:50:11</td>
<td>112</td>
<td><input class="in_btnc1" type="button" value="실행"  OnClick="history.back();" class="input_gr"></td>
</tr>
...
<td><input class="in_btnc1" type="button" value="실행"  OnClick="history.back();" class="input_gr"></td>
		...
		<div style="width:100%; margin-top: 15px; text-align:center;"><input class="in_btn" type="button" value="자동등록"  OnClick="popup_check();"  class="input_gr">&nbsp;&nbsp;<input class="in_btnc" type="button" value="JUMP"  OnClick="history.back();" class="input_gr">          
