...
%>
	...
	function getFacilityNames(){
		...
		var category = "";
		var facility_category = "";
		
		if ( document.getElementById("category") != null ) {
			category = document.getElementById("category").value;
			facility_category = category.substring(2,4);
		}
	...
	function isExplororTen(){
		var NavigatorApplicationVersion = navigator.appVersion;
		var bv = NavigatorApplicationVersion.indexOf('MSIE 10.0');
	...
	function goList(){
		location.href = "boardListView.do?jsp=board/board&category=${category}";
	}
...
<body onLoad="javascript:loadBanner();">
	<form name="writeForm" method="post" action="writeBoard.do" enctype="multipart/form-data">
			...
			<table class="tb3" style="bottom-margin:15;">
				...
				<tbody>
					...
					<tr>
						...
						<td class="subject">
						    <select name="region" id="region" style="width:200;" onchange="javascript:getFacilityNames();">
								...
								<option value="수원권" >수원권</option>
								<option value="인부천" >인부천</option>
								<option value="분당권" >분당권</option>
								<option value="일산권" >일산권</option>
					...
					<tr>
						...
						<td><img src="./images/board_line.gif" width="1" height="22" /></td>
						<td class="subject"><input name="visit_time" class="s_id" type="text" size="45" style="width:200;"></td>
					</tr>
					<tr>
						<td class="subject"><b>언니예명</b></td>
						<td><img src="./images/board_line.gif" width="1" height="22" /></td>
						<td class="subject"><input name="waiteress_name" class="s_id" type="text" size="45" style="width:200;"></td>
					</tr>
					<%
						}
					%>
					...
					<tr>
						...
						<td><img src="./images/board_line.gif" width="1" height="22" /></td>
						<td class="subject"><input name="facility_user_name" class="s_id" type="text" size="45" style="width:200;"></td>
					</tr>
					<tr>
						<td class="subject"><b>대표전화</b></td>
						<td><img src="./images/board_line.gif" width="1" height="22" /></td>
						<td class="subject"><input name="facility_phone" class="s_id" type="text" size="45" style="width:200;"></td>
					</tr>
					<tr>
						<td class="subject"><b>주소</b></td>
						<td><img src="./images/board_line.gif" width="1" height="22" /></td>
						<td class="subject"><input name="facility_address" class="s_id" type="text" size="500" style="width:550;"></td>
					</tr>
					<tr>
						<td class="subject"><b>제목</b></td>
						<td><img src="./images/board_line.gif" width="1" height="22" /></td>
						<td class="subject"><input name="title" class="s_id" type="text" size="65" style="width:550;"></td>
					</tr>
					...
					<tr>
						<td colspan="3" class="subject2">
							...
							<textarea  id="HTMLContent" name="HTMLContent" style="width:720; height:300;"></textarea>
	                       	</div>
	                       	<div id="CKEDiv" style="display:none;">
	                       		<textarea  id="CKEContent" name="CKEContent" style="width:720; height:300;"></textarea>
	                       		<script>
