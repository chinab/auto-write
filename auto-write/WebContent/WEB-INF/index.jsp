...
<!--중앙 로그인 전체-->
<div class="login_bg">
	<div style="width:635px;"><img src="./images/intro_19.gif"><img src="./images/intro_notice.gif"></div>

	<div style="position:relative; width:533px; left:50%; margin:10 0 5 -267;">
		<!--로그인-->
		<div class="login_bg01" style="">
			<form name="myForm" method="post" target="_self" action="dologin.do" style="margin: 0" autocomplete=off>
				<div style="margin-left:22; margin-top:48;">
					<input type="text" class="s_id" value="" name="u_id" id="u_id" style="width:85;ime-mode:disabled;">
